      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Data Kendaraan</a>
          </div>
                    ...
                    <tbody>
                      ...
                      <?php foreach($data_kendaraan as $kendaraan): ?>
                        <?php if($row != 'id'): ?>
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="m<?=$kendaraan['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              <div class="modal-dialog">
                                <form action="<?= base_url('data_Kendaraan/edit/'.$kendaraan['id']) ?>" method="POST">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                      <?php foreach($field as $row_modal_edit): ?>
                                        <?php if($row_modal_edit != 'id'): ?>
                                          <div class="form-group">
                                            <input type="text" name="<?= $row_modal_edit ?>" class="form-control" value="<?= $kendaraan[$row_modal_edit] ?>">
                                          </div> 
                                        <?php endif ?>
                                      <?php endforeach ?>    
                                    </div>
