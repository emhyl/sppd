      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Data SBU</a>
          </div>
                  ...
                  <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <form action="<?= base_url('data_Sbu/tambah') ?>" method="POST">
                      ...
                      <?php foreach($data_sbu as $sbu): ?>
                        <?php if($row != 'id'): ?>
                            ...
                            <tr>
                             ...
                             <?php endforeach ?> 
                             <td>
                               <span class="badge badge-primary"><a href="" class="text-light p-2" data-toggle="modal" data-target="#m<?=$sbu['id'] ?>">Edit</a></span>
                               <span class="badge badge-danger"><a onclick="" href="<?= base_url('data_Sbu/hapus/').$sbu['id'] ?>" class="text-light">Hapus</a></span>
                             </td>
                             
                            </tr>

                            <!-- Modal -->
                            <div class="modal fade" id="m<?=$sbu['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              <div class="modal-dialog">
                                <form action="<?= base_url('data_Sbu/edit/'.$sbu['id']) ?>" method="POST">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                      <?php foreach($field as $row_modal_edit): ?>
                                        <?php if($row_modal_edit != 'id'): ?>
                                          <div class="form-group">
                                            <input type="text" name="<?= $row_modal_edit ?>" class="form-control" value="<?= $sbu[$row_modal_edit] ?>">
                                          </div> 
                                        <?php endif ?>
                                      <?php endforeach ?>    
                                    </div>
